  ...
  return [
    {
      ...
      lastMessagePreview: 'Great work on the energy bill analysis everyone! 👏',
    ...
    },
    {
      ...
      lastMessagePreview: '⚠️ District 12 Campaign: Door pace 18% behind target',
...
export function generateSeedMessages(orgId: string, currentUserId: string): Message[] {
  ...
  return [
    // General Channel Messages
    {
      ...
      reactions: { '👍': ['user_ops', currentUserId], '🔥': [currentUserId] },
      pinned: true,
    ...
    },
    {
      ...
      senderAvatarUrl: null,
      kind: 'text',
      text: 'Great work on the energy bill analysis everyone! 👏',
      attachments: [],
      mentions: [],
      tags: [],
      linked: { projectId: null, taskId: null, billId: null, legislatorId: null, recordId: null },
      replyToMessageId: null,
      reactions: { '🎉': ['user_strategist', 'user_ops'] },
      pinned: false,
    ...
    // Project Thread Messages
    {
      ...
      linked: { projectId: 'proj_campaign_d12', taskId: null, billId: null, legislatorId: null, recordId: null },
      replyToMessageId: null,
      reactions: { '👀': [currentUserId, 'user_ops'] },
      pinned: false,
      createdAt: new Date(now - 7200000).toISOString(),
      editedAt: null,
      version: 1,
    ...
    },
    {
      ...
      senderUserId: 'system_revere',
      senderName: 'Revere',
      text: '⚠️ District 12 Campaign: Door pace 18% behind target\n\n**Current Rate**: 42 doors/hr (target: 50)\n**Projected Shortfall**: 1,200 doors by Saturday\n\n💡 *Recommendation*: Add 2 canvassers to evening shift or extend hours to 8pm',
      kind: 'pythia_insight',
      reactions: {},
      pinned: false,
      replyToMessageId: null,
    ...
    },
    {
      ...
      senderAvatarUrl: null,
      kind: 'pythia_insight',
      text: '📊 **Weekly Summary**: 12 tasks completed, 3 new project milestones reached, 5 bills tracked.',
      attachments: [],
      mentions: [],
      tags: [],
      linked: { projectId: null, taskId: null, billId: null, legislatorId: null, recordId: null },
